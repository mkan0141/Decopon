...
#define TRAINING 5
#define AI_t White //  main AI White -> 後手         Black -> 先手
...
*/
		...
		if(te){
			...
			for(auto v : vec){
				...
				if(game.getStoneNum() >= 49) new_value = ai.AlphaBeta(game, AI_t, !AI_t, 15, -1000000, 1000000, start);
                else new_value = ai.AlphaBeta(game, AI_t, !AI_t, 1, -1000000, 1000000, start);
